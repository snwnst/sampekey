    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_ENVIROMENT_SYSTEM_ROLE_PERMISSION", x => new { x.Id, x.EnviromentId, x.ProjectId, x.RoleId, x.PermissionId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_T_ENVIROMENT_SYSTEM_ROLE_PERMISSION_T_SYSTEM_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_SYSTEM_MODULES", x => new { x.Id, x.ProjectId, x.ModuleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_T_SYSTEM_MODULES_T_SYSTEM_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "T_SYSTEM",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_T_ENVIROMENT_SYSTEM_ROLE_PERMISSION_ProjectId",
                table: "T_ENVIROMENT_SYSTEM_ROLE_PERMISSION",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_T_SYSTEM_MODULES_ProjectId",
                table: "T_SYSTEM_MODULES",
                column: "ProjectId");
